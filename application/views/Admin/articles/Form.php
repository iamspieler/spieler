	       ...
	       <div class="row-fluid">
		    <div>
			 <?= Form::open(URL::base('http').Kohana::$config->load('global.site_ap_url').'/'.$mod_url.'/'.$mod_action.'/', array('method' => 'POST', 'name' => 'news_form', 'enctype' => 'multipart/form-data', 'id' => 'form_news', 'class' => 'well p_form')); ?>
			      ...
			      <? if($articles_list['article_title'] != '') { ?><big><i><?= $articles_list['article_title']; ?></i></big><br /><br /> <? } ?>
			      <div class="clearfix"></div>
			      ...
			      <div id="myTabContent" class="tab-content">
				   <div class="tab-pane fade in active" id="tabm">
					<div class="control-group">
					     <?= Form::label('content_title', __('Article_title'), array('class' => 'control-label')); ?>
					     <div class="controls controls-row">
						  <?= Form::input('article_title', $articles_list['article_title'], array('class' => 'input span6', 'id' => 'content_title', 'placeholder' => __('Article_title'), 'required' => '')); ?>
					     </div>
					</div>
					<div class="control-group">
					     <?= Form::label('content_subtitle', __('Article_subtitle'), array('class' => 'control-label')); ?>
					     <div class="controls controls-row">
						  <?= Form::input('article_subtitle', $articles_list['article_subtitle'], array('class' => 'input span6', 'id' => 'content_subtitle', 'placeholder' => __('Article_subtitle'), 'required' => '')); ?>
					     </div>
					</div>
					<div class="control-group">
					     <?= Form::label('content_url', __('URL'), array('class' => 'control-label')); ?>
					     <div class="controls controls-row">
						  <?= Form::input('article_url', $articles_list['article_url'], array('class' => 'input span6', 'id' => 'content_url', 'placeholder' => __('URL'), 'required' => '')); ?>
						  <div class="clearfix"></div>
